...
class Firebase:
    ...
    def push_data(self):
        ...
        push_service = FCMNotification(
            api_key="AAAACnosiMA:APA91bEqyBuwY_7H6V6MwtDUpMIx3XhIC3pKJYtMPKQF8CsdRbXIEjiOIt-8AxLwC8uDLKKjiXQXxP44QFlMZENKnxxdAqUZ7bbkqjt49QSy0lEvTEXjrvu_pzLPpWaj_4w-SSf6RAMo")
        registration_ids = [
            "dC8ej3vBSRmSn48yH31f9u:APA91bFjHLUqS-hJ7JHt0gTvuWQAK_mGKS6fLmkJFiOf1GifO3z0b1GR7HjLSfJ12A6542X3ZVXBtUQIYYf8Hul3YQbYPweJfMwULqVE-Z7EmPhcSOF_wD84jrpapNjfxGW9eGVUMibW"]
        message_title = "Thông báo có người để quên "
        message_body = "Chào anh, có người để quên đồ trong cửa hàng mau mau nhắc khách đi má"
